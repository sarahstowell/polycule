    ...
    */
    ...
    function mouseup() {
	    ...
	    if (connect1 === 1) {
		    ...
		    if (name === null || name === '' /*&& isSafari && confirm('was that cancel?')*/) {
			    ...
			    nodes.push({"id": new_node, "username": null, "name": name, "location": null, "description": null, "member": 0, "invited": 0, "photo": null, "photocoords": null, "x":point[0], "y": point[1]});	// Add new node to dataset
    ...
    function restart() {
        ...
        link
            ...
            .classed("ghostLink", function(d) { if (d.ghostNode === 1) { return true ; } else { return false; } })
        ...
        node.select("circle")      
            ...
            .attr("class", function(d) { if (d.id === loggedin) { return "myNode"; } else if (d.ghostNode === 1) { return "ghostNode"; } else if (d.member === 1) { return "userNode"; } else { return "nonUserNode"; } })
            .classed("selectedNode", function(d) { if (d.id === active_node) { return true; } else { return false; } })
            //.classed("ghostNode", function(d) { if (d.ghostNode === 1) { return true ; } else { return false; } })
