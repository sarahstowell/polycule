    ...
    function ViewModel(linkData, emailData, loggedin) {
        ...
        self.sendMessage = function() {
            ...
            if (content) {
			    ...
			    document.getElementById("emailContainer").scrollTop = document.getElementById("emailContainer").scrollHeight - document.getElementById("emailContainer").clientHeight;
			}
        }
    }
